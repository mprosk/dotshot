...
class USBCamera:
    ...
    def capture_frame(self, warmup_frames: int = 0) -> np.ndarray:
        ...
        # Discard buffered frames if requested
        if warmup_frames > 0:
            self._logger.debug("Flushing %d frames before capture", warmup_frames)
